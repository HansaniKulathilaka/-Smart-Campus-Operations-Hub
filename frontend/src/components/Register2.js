...
function Register(){
    ...
    const sendRequest = async () => {
        try {
            await axios.post("http://localhost:8080/user2/add", {
                ID: inputs.ID,
    ...
    return(
        <div style={containerStyle}>
           ...
           <h1 style={{fontSize:'40px', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", color: "#f10e0eff",margin: "100px"}}><b>Join with us!<br></br> Explore more with SLIIT Connect</b></h1>
            ...
            <form onSubmit={handleSubmit} style={formStyle}>
                <label><h1>SLIIT Id number</h1></label>
